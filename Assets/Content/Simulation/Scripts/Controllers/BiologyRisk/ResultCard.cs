...
public class ResultCard : MonoBehaviour {
	...
	void LoadInfo(){
		...
		foreach(var file in file1){
			...
			((RectTransform)section1).sizeDelta = new Vector2 (((RectTransform)section1).sizeDelta.x, ((RectTransform)section1).sizeDelta.y + 25);
			((RectTransform)tableResult).sizeDelta = new Vector2 (((RectTransform)tableResult).sizeDelta.x, ((RectTransform)tableResult).sizeDelta.y + 25);
			item.name = "Row";
			...
			float puntaje = file.Score * 10.0f;
			item.Find ("NoteValue").GetComponent<Text> ().text = puntaje.ToString("#.##");
			if (file.Score == 0) {
		...
		section1.Find("Total").Find("Note").GetComponent<Text>().text = totalScoreSection1.ToString("#.##");
		...
		section2.Find("Total").Find("Note").GetComponent<Text>().text = totalScoreSection2	.ToString("#.##");
		...
		foreach(var file in file4){
			...
			((RectTransform)section3).sizeDelta = new Vector2 (((RectTransform)section1).sizeDelta.x, ((RectTransform)section1).sizeDelta.y + 25);
			((RectTransform)tableResult).sizeDelta = new Vector2 (((RectTransform)tableResult).sizeDelta.x, ((RectTransform)tableResult).sizeDelta.y + 25);
			item.name = "Row";
			item.localScale = Vector3.one;
			item.anchoredPosition3D = new Vector3 (0, 0, 0);
			...
			item.Find ("Total").GetComponent<Text> ().text = file.Score.ToString("#.##");
		...
		section3.Find("Total").Find("Note").GetComponent<Text>().text = totalScoreSection3.ToString("#.##");
		...
		foreach(var file in file5){
			...
			item.SetSiblingIndex(2);
			((RectTransform)section4).sizeDelta = new Vector2 (((RectTransform)section1).sizeDelta.x, ((RectTransform)section1).sizeDelta.y + 25);
			((RectTransform)tableResult).sizeDelta = new Vector2 (((RectTransform)tableResult).sizeDelta.x, ((RectTransform)tableResult).sizeDelta.y + 25);
			item.name = "Row";
			item.localScale = Vector3.one;
			item.anchoredPosition3D = new Vector3 (0, 0, 0);
			...
			item.Find ("Factor").GetComponent<Text> ().text = file.RiskFactor;
		...
		section4.Find("Total").Find("Note").GetComponent<Text>().text = totalScoreSection4.ToString("#.##");
		...
		totalSection.Find("Result1").Find("Note").GetComponent<Text>().text = totalScoreSection1.ToString("#.##");
		totalSection.Find("Result1").Find("Note").GetComponent<Text>().color = section1.Find("Total").Find("Note").GetComponent<Text>().color;

		totalSection.Find("Result2").Find("Note").GetComponent<Text>().text = totalScoreSection2.ToString("#.##"); 
		totalSection.Find("Result2").Find("Note").GetComponent<Text>().color = section2.Find("Total").Find("Note").GetComponent<Text>().color;

		totalSection.Find("Result3").Find("Note").GetComponent<Text>().text = totalScoreSection3.ToString("#.##");
		totalSection.Find("Result3").Find("Note").GetComponent<Text>().color = section3.Find("Total").Find("Note").GetComponent<Text>().color;
	
		totalSection.Find("Result4").Find("Note").GetComponent<Text>().text = totalScoreSection4.ToString("#.##");
		...
		totalSection.Find("Total").Find("Note").GetComponent<Text>().text = resultEvaluation.ToString("#.##");
